    ...
    <div className='flex flex-wrap h-screen'>
      <div className='flex justify-center items-center flex-col h-screen w-full lg:w-1/2'>
        ...
        {errorLogin ? (
          ...
          <div className='text-gray-400  leading-7 mt-4'>Sign in to stay connected.</div>
        )}
        <BaseInput classExtend='mt-4' classInput='w-96' label='Email' onChange={(e) => setEmail(e.target.value)} />
        <BaseInput
          classExtend='mt-4'
          classInput='w-96'
          label='Password'
        ...
        <div className='mt-1'>
          ...
          <Link to='/signup'>
            <span className='text-[#C7923E]  leading-7'>Click here to sign up.</span>
          </Link>
        </div>
      </div>
