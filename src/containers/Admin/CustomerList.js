...
import { getCustomerById, getCustomerList, searchByNameUser } from '../../utils/admin';
...
const BodyTableRow = ({ customerId, name, gender, phone, img, dob, handleDisplayDetail }) => {
  return (
    <tbody>
      <tr>
        ...
        <td className='py-3 border-b border-gray-300' onClick={() => handleDisplayDetail(customerId)}>
