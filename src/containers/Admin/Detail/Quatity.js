...
function Quantity() {
  ...
  return (
    <>
      ...
      <div className='p-10 w-full bg-gray-100 grid grid-cols-3 gap-2'>
        <div className='rounded-lg border border-stroke bg-white py-6 px-4 shadow-default h-52'>
          ...
          <div className='mt-4 flex items-end justify-between'>
            <div>
              <h4 className='text-title-md font-bold text-black dark:text-white'>{summary?.totalCustomer}</h4>
        ...
        <div className='rounded-lg border border-stroke bg-white py-6 px-4 shadow-default h-52'>
          ...
          <div className='mt-4 flex items-end justify-between'>
            <div>
              <h4 className='text-title-md font-bold text-black dark:text-white'>{summary?.totalGuard}</h4>
        ...
        <div className='rounded-lg border border-stroke bg-white py-6 px-4 shadow-default h-52'>
          ...
          <div className='mt-4 flex items-end justify-between'>
            <div>
              <h4 className='text-title-md font-bold text-black dark:text-white'>{summary?.total_booking}</h4>
        ...
        <div className='rounded-lg border border-stroke bg-white py-6 px-4 shadow-default h-52'>
          ...
          <div className='flex items-end justify-between'>
            <div>
              <h4
                className={`text-title-md font-extrabold ${
                  amountFormatting(summary?.total_profit) < 0 ? 'text-green-600' : 'text-red-700'
                } dark:text-white`}
              >
