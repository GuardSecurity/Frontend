  ...
  return (
    <div className='w-full my-10 px-10'>
      ...
      <div className='flex justify-center mt-20'>
        {/* <div className="grid grid-cols-3 gap-6 w-2/3 h-26">
        ...
        {role === 2 && (
          <div className='w-full flex-col'>
            <div className='flex justify-center'>
              <div className='grid grid-cols-4 gap-4 w-2/3 h-26'>
            ...
            <div className='flex justify-center'>
              <BaseButton content='Save' className='bg-yellow-600' onClick={handleAttendance} />
            </div>
          </div>
        )}
      </div>
