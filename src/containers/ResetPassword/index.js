...
import sendEmailSuccess from '../../assets/sendEmailSuccess.png';

function SendEmailSuccess() {
  return (
    <div className='flex flex-wrap h-screen'>
      <div className='flex justify-center items-center flex-col h-screen w-full lg:w-1/2'>
        <img src={sendEmailSuccess} alt='Icon' />
        <div className='text-blue-800 text-6xl font-bold mt-4'>Success !</div>
        <div className='w-96 mt-6 text-center text-slate-800 leading-7'>
        ...
        <BaseButton className='bg-[#C7923E] w-48 h-11 mt-6 rounded' content='Back to home' />
      </div>
